	...
	<div id="booking" id="page">
		<div id="content">
			<a href="javascript:history.back()"><font style="color: red; background-color: #1a1b1d; font-weight: 80; padding: 5px 5px; font-size: 16px; border: 0px #ffc600; margin-left: 80%;">Back to Previous Page</font></a>
				<a href="reservetraveller.php?check"><font style="color: red; background-color: #1a1b1d; font-weight: 80; padding: 5px 5px; font-size: 16px; border: 0px #ffc600; margin-left: 80%;">Checkout Now</font></a>
				<div class="booking-form" style="padding: 0 0 223px 0; margin: 0; width: 100%;">
					<div class="booking-bg"></div>
					<form action="reservecart.php" method="POST" enctype="multipart/form-data" style="margin: 0; width: 150%;">
						...
						for($i=0;$i<$rcount;$i++)
						{
							...
							echo "<td><a href='reservecart.php?action=remove&TicketID=".$data['TicketID']."'><font style='color: red; background-color: #1a1b1d; font-weight: 50; padding: 5px 5px; font-size: 14px; border: 0px #ffc600;'>Remove</font></a></td>";
							echo "</tr>";
							$fare=$data['Fare'];
							$total+=$fare;
						}
