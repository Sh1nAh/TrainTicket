...
<body>
	...
	<div id="booking" id="page">
		<div id="content">
			...
			<a href="cart.php"><font style="color: red; background-color: #1a1b1d; font-weight: 80; padding: 5px 5px; font-size: 16px; border: 0px #ffc600; margin-left: 80%;">Shopping Cart</font></a>
			...
			<?php
				...
				$query=mysql_query("SELECT * FROM ticket where Date='$date' OR TrainType='$ttype' OR ArrivalStation='$astation' OR Route='$route' AND Status='Available'") or die ("Cann't Select");
				...
				<td>
					...
					<a href="display.php?action=add&TicketID=<?php echo $TicketID; ?>"><font style="color: red; background-color: #1a1b1d; font-weight: 50; padding: 5px 5px; font-size: 14px; border: 0px #ffc600;">Add</font></a>
				</td>
			</tr>
			<?php
				}
